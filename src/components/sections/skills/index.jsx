...
const SkillsSection = () => {
  ...
  return (
    <div ref={scope} className="overflow-hidden mt-12 mx-5 lg:mx-15">
      <div
        ref={scrollTrack1}
      ...
      >
        {skills.map((skill, index) => (
          <div
            key={index}
            className="flex items-center gap-x-1.5 lg:text-3xl text-[#ABB2BF] uppercase font-semibold transition-colors duration-300 hover:text-green-500 cursor-pointer"
          >
            <skill.Icon />
            {skill.name}
          </div>
